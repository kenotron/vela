"""Engine — mode-agnostic core for vela_agentd_lib.
...
from vela_agentd_lib.protocol import (
    PROTOCOL_VERSION,
    AgentShutdownResult,
    InitializeResult,
    TurnSubmitResult,
...
from vela_agentd_lib.protocol_points import ApprovalSystem, DisplaySystem, ProtocolPoints
