...
Entry-point (see pyproject.toml [project.scripts]):
    amplifier-agent-post-install = 'vela_agentd_lib.post_install:cli_entry'
...
from vela_agentd_lib.bundle.cache import cache_dir_for_version, load_and_prepare_cached
