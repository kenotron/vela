# src/vela_agentd_lib/protocol/_gen.py
"""Wire-spec generator.
...
Regenerate via:
    uv run python -m vela_agentd_lib.protocol._gen \
        --output-dir src/vela_agentd_lib/protocol
"""
...
from vela_agentd_lib.protocol.errors import ErrorCode
from vela_agentd_lib.protocol.methods import PROTOCOL_VERSION
from vela_agentd_lib.protocol.notifications import CANONICAL_DISPLAY_EVENTS
...
_PROTOCOL_MODULES: tuple[str, ...] = (
    "vela_agentd_lib.protocol.methods",
    "vela_agentd_lib.protocol.notifications",
    "vela_agentd_lib.protocol.capabilities",
)
...
def _render_spec_md(typed_dicts: list[type]) -> str:
    ...
    capability_tds = [td for td in typed_dicts if td.__module__ == "vela_agentd_lib.protocol.capabilities"]

    lines: list[str] = []
    lines.append("<!-- GENERATED FILE — DO NOT HAND-EDIT.")
    lines.append("     Regenerate with:")
    lines.append("       uv run python -m vela_agentd_lib.protocol._gen \\")
    lines.append("           --output-dir src/vela_agentd_lib/protocol")
    lines.append("-->")
    lines.append("")
