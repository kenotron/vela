...
:class:`vela_agentd_lib.protocol.errors.AaaError`, the CLI's existing
...
it here so callers continue to use ``from vela_agentd_lib.config
import ConfigError``.
"""

from __future__ import annotations

from vela_agentd_lib.config.loader import ConfigError, load_config
from vela_agentd_lib.config.merger import merge_config
