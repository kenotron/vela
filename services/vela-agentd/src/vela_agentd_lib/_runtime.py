...
from vela_agentd_lib import __version__
from vela_agentd_lib.bundle.cache import load_and_prepare_cached
from vela_agentd_lib.config import merge_config
from vela_agentd_lib.engine import TurnContext, TurnHandler
from vela_agentd_lib.incremental_save import IncrementalSaveHook
from vela_agentd_lib.persistence import state_root
from vela_agentd_lib.session_store import SessionStore
from vela_agentd_lib.wire_approval_provider import WireApprovalProvider
...
def make_turn_handler(
    ...
    *,
    ...
    """
    from vela_agentd_lib.bundle.hook_streaming import mount as mount_streaming_hook
    from vela_agentd_lib.persistence import resolve_workspace
    from vela_agentd_lib.spawn import hydrate_agent_overlay, spawn_sub_session
