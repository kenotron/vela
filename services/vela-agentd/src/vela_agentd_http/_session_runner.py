...
copy-and-adapt -- the body of ``vela_agentd_lib._runtime.make_turn_handler``
...
from vela_agentd_cli.provider_sources import inject_provider
from vela_agentd_lib.bundle.hook_streaming import mount as mount_streaming_hook
from vela_agentd_lib.bundle.host_tool_hook import mount as mount_host_tool_hook
from vela_agentd_lib.bundle.host_tool_proxy import HostToolProxy
...
if TYPE_CHECKING:
    from amplifier_foundation.bundle._prepared import (
        PreparedBundle,  # type: ignore[reportMissingImports]
    )
