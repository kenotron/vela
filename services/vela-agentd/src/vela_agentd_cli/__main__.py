...
- Subcommand routing: all business logic lives in vela_agentd_lib; this
...
from vela_agentd_cli import __version__
from vela_agentd_cli.admin.auth import auth_group as _auth_group
from vela_agentd_cli.admin.cache_clear import cache_group as _cache_group
from vela_agentd_cli.admin.config_show import config_group as _config_group
from vela_agentd_cli.admin.doctor import doctor as _doctor_command
from vela_agentd_cli.admin.migrate import migrate_command as _migrate_command
from vela_agentd_cli.admin.models import models_group as _models_group
from vela_agentd_cli.admin.prepare import prepare as _prepare_command
from vela_agentd_cli.admin.serve import serve_group as _serve_group
from vela_agentd_cli.admin.update import update_command as _update_command
from vela_agentd_cli.admin.verify import verify as _verify_command
from vela_agentd_cli.admin.version_info import version_command as _version_command
from vela_agentd_cli.modes.single_turn import run as _run_command
