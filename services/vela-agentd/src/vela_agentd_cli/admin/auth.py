...
:func:`vela_agentd_cli.provider_sources._resolve_env_credential`):
...
from vela_agentd_cli.provider_sources import KNOWN_PROVIDERS, PROVIDER_CREDENTIAL_VARS
from vela_agentd_lib.persistence import amplifier_agent_home
...
def credentials_path() -> Path:
    ...
    project (see :mod:`vela_agentd_lib.persistence`).
    """
